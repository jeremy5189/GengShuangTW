...
var sentence_negative = {
    sc: [
        ...
        "中国政府和中国人民坚决反对#N#B的行为，#OURSIDE已就此向#N提出严正交涉和强烈抗议。",
        "#OURSIDE强烈敦促#N不得#B，以免影响两国关系和两国在重要领域的合作。",
        "#OURSIDE强烈谴责并坚决反对#N#B，已就此向#N提出了严正交涉。",
        "#N如果#B，不仅将损害#OURSIDE利益，损害中国和#N关系，也将严重损害#N自身的利益。",
        ...
        "对于#N干涉中国内政、损害#OURSIDE利益的行径，#OURSIDE必将采取有力措施坚决反制。任何人都不要低估#OURSIDE维护国家主权、安全、发展利益的坚定决心。",
        ...
        "#N罔顾事实、混淆是非、违反公理，玩弄双重标准，公然插手中国事务，干涉中国内政，严重违反国际法和国际关系基本准则，#OURSIDE对此表示强烈谴责和坚决反对。",
        "#N任何企图干预中国内政、阻碍中国发展的把戏都不会得逞，到头来只会是枉费心机一场空。",
        "#N这一恶劣行径不仅损害#OURSIDE利益，也会损害#N自身的重要利益。",
        "我们希望#N认真对待#OURSIDE的严正交涉和严正立场，立即停止不负责任的言行，停止干涉中国内政。",
        ...
        "#OURSIDE正告#N，任何企图破坏中国社会繁荣稳定、阻碍中国发展的图谋都不会得逞，到头来只会搬起石头砸自己的脚。",
    ...
    tc: [
        ...
        "中國政府和中國人民堅決反對#N#B的行為，#OURSIDE已就此向#N提出嚴正交涉和強烈抗議。",
        "#OURSIDE強烈敦促#N不得#B，以免影響兩國關係和兩國在重要領域的合作。",
        "#OURSIDE強烈譴責並堅決反對#N#B，已就此向#N提出了嚴正交涉。",
        "#N如果#B，不僅將損害#OURSIDE利益，損害中國和#N關係，也將嚴重損害#N自身的利益。",
        ...
        "對於#N干涉中國內政、損害#OURSIDE利益的行徑，#OURSIDE必將採取有力措施堅決反制。任何人都不要低估#OURSIDE維護國家主權、安全、發展利益的堅定決心。",
        ...
        "#N罔顧事實、混淆是非、違反公理，玩弄雙重標準，公然插手中國事務，干涉中國內政，嚴重違反國際法和國際關係基本準則，#OURSIDE對此表示強烈譴責和堅決反對。",
        "#N任何企圖干預中國內政、阻礙中國發展的把戲都不會得逞，到頭來只會是枉費心機一場空。",
        "#N這一惡劣行徑不僅損害#OURSIDE利益，也會損害#N自身的重要利益。",
        "我們希望#N認真對待#OURSIDE的嚴正交涉和嚴正立場，立即停止不負責任的言行，停止干涉中國內政。",
        ...
        "#OURSIDE正告#N，任何企圖破壞中國社會繁榮穩定、阻礙中國發展的圖謀都不會得逞，到頭來只會搬起石頭砸自己的腳。",
...
var sentence_positive = {
    sc: [
        ...
        "#OURSIDE对#N#B表示祝贺。中国与#N传统友谊深厚，双方是患难与共的好兄弟，真诚相待的好朋友，共同发展的好伙伴。",
        ...
        "#OURSIDE愿在一个中国原则和和平共处五项原则基础上，同#N加强各领域务实合作和友好交流，造福两国和两国人民。",
        "中国与#N的合作始终遵循平等互利、合作共赢和商业化原则开展，合法合规，利国利民，不容他国置喙。",
        "#OURSIDE坚信，不论形势如何变化，中国与#N的合作都会正常开展下去。",
        ...
        "我们刚刚隆重庆祝了新中国成立70周年，#N向#OURSIDE送上了真挚美好的祝福，我们对此表示诚挚的感谢。",
    ...
    tc: [
        ...
        "#OURSIDE對#N#B表示祝賀。中國與#N傳統友誼深厚，雙方是患難與共的好兄弟，真誠相待的好朋友，共同發展的好夥伴。",
        ...
        "#OURSIDE願在一箇中國原則和和平共處五項原則基礎上，同#N加強各領域務實合作和友好交流，造福兩國和兩國人民。",
        "中國與#N的合作始終遵循平等互利、合作共贏和商業化原則開展，合法合規，利國利民，不容他國置喙。",
        "#OURSIDE堅信，不論形勢如何變化，中國與#N的合作都會正常開展下去。",
        ...
        "我們剛剛隆重慶祝了新中國成立70週年，#N向#OURSIDE送上了真摯美好的祝福，我們對此表示誠摯的感謝。",
...
function gengshuang(n, b, ourside) {
    ...
    return gengshuang_replace(answer, n, b, ourside)
}


function gengshuang_replace(answer, n, b, ourside) {
...
function generate() {
    ...
    if (n.length === 0 || b.length === 0 || ourside.length === 0) {
        ...
        t.innerHTML = gengshuang(n, b, ourside)
