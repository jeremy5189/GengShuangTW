...
var sentence_negative = {
    sc: [
        ...
        "#N罔顾事实、颠倒黑白，公然#B，性质极其恶劣，用心十分险恶，其根本目的是干涉#OURSTATE内政，破坏中华民族实现伟大复兴的历史进程。",
        ...
        "#OURSIDE强烈敦促#N不得#B，以免影响两国关系和两国在重要领域的合作。",
    ...
    tc: [
        ...
        "#N罔顧事實、顛倒黑白，公然#B，性質極其惡劣，用心十分險惡，其根本目的是干涉#OURSTATE內政，破壞中華民族實現偉大復興的歷史進程。",
        ...
        "#OURSIDE強烈敦促#N不得#B，以免影響兩國關係和兩國在重要領域的合作。",
...
var sentence_positive = {
    sc: [
        ...
        "#B，是#N各界的普遍期待，符合两国和两国#MEMBER的根本和长远利益。",
        ...
        "作为#OURSTATE与#N人文交流的重要内容，#B长期以来有力地促进了两国#MEMBER之间的沟通和相互了解。",
        "我们希望#N有关各方在宪法和法律框架内和平#B。",
        "同时我们希望#N在#B过程中秉持公平、透明、非歧视原则，对各方一视同仁。",
        "#OURSIDE愿为#N#B发挥积极作用。",
        "#OURSIDE愿同#N一道，以#B为契机，增进政治互信，深化互利合作，加强在国际和地区事务中的沟通协调，造福两国#MEMBER。",
        "#OURSTATE和#N互为战略伙伴。自建交以来，双方关系取得长足发展，各领域务实合作成果丰硕。",
        "#OURSIDE愿同#N一道努力，巩固友好互信，深化互利合作，推动战略伙伴关系取得更大发展。",
        "#OURSTATE和#N建交以来，两国各领域交流合作快速展开，成果持续显现，增进了两国#MEMBER的福祉。",
        "当前，#OURSTATE同#N关系快速发展。两国#MEMBER一直相互怀有友好感情。",
        "#OURSIDE愿在一个#OURSTATE原则和和平共处五项原则基础上，同#N加强各领域务实合作和友好交流，造福两国和两国#MEMBER。",
        "#OURSTATE与#N的合作始终遵循平等互利、合作共赢和商业化原则开展，合法合规，利国利民，不容他国置喙。",
        "#OURSIDE坚信，不论形势如何变化，#OURSTATE与#N的合作都会正常开展下去。",
        "我们愿意与#N共同努力，开启两国关系发展新的广阔前景。",
        "事实充分证明，#OURSTATE与#N关系的发展不仅给两国#MEMBER带来巨大利益，也有力地促进了亚太地区和世界的和平、稳定、繁荣。",
        "#OURSTATE与#N是好朋友、好伙伴、好兄弟。",
        "#OURSIDE愿同#N一道，继续加强战略沟通，深化务实合作，深入落实两国元首共识，推动全面战略伙伴关系不断迈上新台阶。",
        ...
        "#N此举这符合双方的共同利益，也是两国#MEMBER的共同期待。",
    ...
    tc: [
        ...
        "#B，是#N各界的普遍期待，符合兩國和兩國#MEMBER的根本和長遠利益。",
        ...
        "作為#OURSTATE與#N人文交流的重要內容，#B長期以來有力地促進了兩國#MEMBER之間的溝通和相互瞭解。",
        "我們希望#N有關各方在憲法和法律框架內和平#B。",
        "同時我們希望#N在#B過程中秉持公平、透明、非歧視原則，對各方一視同仁。",
        "#OURSIDE願為#N#B發揮積極作用。",
        "#OURSIDE願同#N一道，以#B為契機，增進政治互信，深化互利合作，加強在國際和地區事務中的溝通協調，造福兩國#MEMBER。",
        "#OURSTATE和#N互為戰略伙伴。自建交以來，雙方關係取得長足發展，各領域務實合作成果豐碩。",
        "#OURSIDE願同#N一道努力，鞏固友好互信，深化互利合作，推動戰略伙伴關係取得更大發展。",
        "#OURSTATE和#N建交以來，兩國各領域交流合作快速展開，成果持續顯現，增進了兩國#MEMBER的福祉。",
        "當前，#OURSTATE同#N關係快速發展。兩國#MEMBER一直相互懷有友好感情。",
        "#OURSIDE願在一箇#OURSTATE原則和和平共處五項原則基礎上，同#N加強各領域務實合作和友好交流，造福兩國和兩國#MEMBER。",
        "#OURSTATE與#N的合作始終遵循平等互利、合作共贏和商業化原則開展，合法合規，利國利民，不容他國置喙。",
        "#OURSIDE堅信，不論形勢如何變化，#OURSTATE與#N的合作都會正常開展下去。",
        "我們願意與#N共同努力，開啟兩國關係發展新的廣闊前景。",
        "事實充分證明，#OURSTATE與#N關係的發展不僅給兩國#MEMBER帶來巨大利益，也有力地促進了亞太地區和世界的和平、穩定、繁榮。",
        "#OURSTATE與#N是好朋友、好夥伴、好兄弟。",
        "#OURSIDE願同#N一道，繼續加強戰略溝通，深化務實合作，深入落實兩國元首共識，推動全面戰略伙伴關係不斷邁上新臺階。",
        ...
        "#N此舉這符合雙方的共同利益，也是兩國#MEMBER的共同期待。",
