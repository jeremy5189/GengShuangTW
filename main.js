...
var sentence_negative = {
    sc: [
        "#N#B的举动严重干涉了#OURSTATE内政，严重违反国际法和国际关系基本准则，是赤裸裸的霸权行径，#OURSTATE和人民坚决反对。",
        "#N罔顾事实、颠倒黑白，公然#B，性质极其恶劣，用心十分险恶，其根本目的是干涉#OURSTATE内政，破坏中华民族实现伟大复兴的历史进程。",
        "#B只会让广大#OURSTATE人民进一步认清#N的险恶用心和霸权本质，只会让#OURSTATE人民更加众志成城。",
        "#OURSTATE政府和#OURSTATE人民坚决反对#N#B的行为，#OURSIDE已就此向#N提出严正交涉和强烈抗议。",
        ...
        "#N试图挑拨#OURSTATE共产党和#OURSTATE人民的关系，极其阴险。",
        "任何妄图否定#OURSTATE的社会主义制度、挑拨#OURSTATE共产党和#OURSTATE人民关系的政治图谋都注定不会得逞！",
    ...
    tc: [
        "#N#B的舉動嚴重干涉了#OURSTATE內政，嚴重違反國際法和國際關係基本準則，是赤裸裸的霸權行徑，#OURSTATE和人民堅決反對。",
        "#N罔顧事實、顛倒黑白，公然#B，性質極其惡劣，用心十分險惡，其根本目的是干涉#OURSTATE內政，破壞中華民族實現偉大復興的歷史進程。",
        "#B只會讓廣大#OURSTATE人民進一步認清#N的險惡用心和霸權本質，只會讓#OURSTATE人民更加眾志成城。",
        "#OURSTATE和#OURSTATE人民堅決反對#N#B的行為，#OURSIDE已就此向#N提出嚴正交涉和強烈抗議。",
        ...
        "#N試圖挑撥#OURSTATE共產黨和#OURSTATE人民的關係，極其陰險。",
        "任何妄圖否定#OURSTATE的社會主義制度、挑撥#OURSTATE共產黨和#OURSTATE人民關係的政治圖謀都註定不會得逞！",
...
function gengshuang(n, b, ourside, ourstate) {
    ...
    return gengshuang_replace(answer, n, b, ourside, ourstate)
}


function gengshuang_replace(answer, n, b, ourside, ourstate) {
...
function generate() {
    ...
    if (n.length === 0 || b.length === 0 || ourside.length === 0) {
        ...
        s_html_tmp = gengshuang_replace(s_html_tmp, n, b, ourside)
        s.innerHTML = s_html_tmp
        document.getElementById("text").appendChild(s)
        var t = document.createElement("p")
        t.innerHTML = gengshuang(n, b, ourside, ourstate)
